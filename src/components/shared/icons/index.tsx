...
export const WishlistIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ExternalLinkIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const BookOpenIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const NewsLetterIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const AlertCircleIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const RefreshCwIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
  ...
  >
    <path 
      ...
      strokeLinejoin="round" 
      strokeWidth={2} 
      d="M1 4v6h6m16 10v-6h-6M8 20a8 8 0 1 0 0-16 8 8 0 0 0 0 16z" 
    />
  </svg>
);
...
export const AlertTriangleIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const ServerIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const DatabaseIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const Clock3Icon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const NetworkIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// HeartIcon component with filled support
...
// ShoppingBasketIcon component
export const ShoppingBasketIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
  ...
  >
    <path 
      ...
      strokeLinejoin="round" 
      strokeWidth={2} 
      d="M3 3h2l.4 2M7 13h10l4-8H5.4m1.6 8L6 5H3m4 8l-1 5h12l-1-5M9 19v1a1 1 0 102 0v-1m4 0v1a1 1 0 102 0v-1" 
    />
  </svg>
);

// AnalyticsIcon component
...
// Follow status icons
export const FollowIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const WatchIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const HoldIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const UnfollowIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const FundaIcon: React.FC<IconProps> = ({ className = "w-4 h-4", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// News Icons
export const PinIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const PinOffIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
// My Bucket Icons
export const BucketIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const BarChart2Icon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const Maximize2Icon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg
    className={className}
    width={size || 20}
    height={size || 20}
...
// export const Minimize2Icon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
//   <svg
//     className={className}
//     width={size || 20}
//     height={size || 20}
...
export const GripVerticalIcon: React.FC<IconProps> = ({ className = "w-5 h-5", size }) => (
  <svg
    className={className}
    width={size || 20}
    height={size || 20}
...
export const ConsolidationIcon: React.FC<IconProps> = ({ className = "w-6 h-6", size }) => (
  <svg
    className={className}
    width={size}
    height={size}
